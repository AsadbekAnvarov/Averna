...
interface LQuestion { question: string; options: string[]; answer: number; }
interface Section { title: string; transcript: string; questions: LQuestion[]; }
interface LTest { id: string; title: string; difficulty: "Easy" | "Medium" | "Hard"; description: string; sections: Section[]; }
