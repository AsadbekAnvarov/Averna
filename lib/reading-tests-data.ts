...
Despite these impressive achievements, current AI systems still lack many capabilities that humans take for granted, such as common sense reasoning, genuine understanding, and the ability to learn from small amounts of data. A child can learn to recognise a giraffe after seeing one picture; most AI systems require thousands. Researchers continue to work on these challenges, aiming to develop more general and flexible AI systems that might one day match — or exceed — the breadth of human intelligence.`,
        questions: [
          { id: "q1", type: "multiple-choice", question: "Who first coined the term 'artificial intelligence'?", options: ["Alan Turing", "John McCarthy", "The US military", "A group at Stanford"], correctAnswer: 1 },
          { id: "q2", type: "multiple-choice", question: "According to the passage, what was one main cause of the 'AI winter'?", options: ["A worldwide shortage of computers", "Governments banning AI research", "The high cost and limited flexibility of expert systems", "Deep learning replacing older methods"], correctAnswer: 2 },
          { id: "q3", type: "multiple-choice", question: "Which THREE factors together enabled the AI resurgence in the 21st century?", options: ["Faster software, cheaper hardware, and simpler algorithms", "Big datasets, better processing power, and refined neural networks", "Government funding, expert systems, and machine learning", "Rule-based approaches, cloud computing, and open-source code"], correctAnswer: 1 },
          { id: "q4", type: "true-false-not-given", question: "Early AI programs could only solve problems in specific, narrow areas.", correctAnswer: "true" },
          { id: "q5", type: "true-false-not-given", question: "Expert systems were cheap to develop and maintain.", correctAnswer: "false" },
          { id: "q6", type: "true-false-not-given", question: "The AI winter began in the early 1970s.", correctAnswer: "false" },
          { id: "q7", type: "true-false-not-given", question: "Modern AI systems can learn new categories from just a few examples as easily as humans do.", correctAnswer: "false" },
          { id: "q8", type: "true-false-not-given", question: "Deep learning was invented after the year 2010.", correctAnswer: "not-given" },
          { id: "q9", type: "sentence-completion", question: "Current AI systems still lack ___________ that humans possess naturally.", correctAnswer: "common sense reasoning" },
          { id: "q10", type: "sentence-completion", question: "The 1956 conference at ___________ marked the beginning of AI as a field.", correctAnswer: "Dartmouth" },
        ],
      },
      {
        id: "passage-2",
...
The debate over the future of social media is intensifying. Some argue for stricter regulation and even breaking up the largest companies, on the grounds that their influence is now too great. Others believe that heavy-handed rules would damage free speech and stifle innovation. What seems clear is that the platforms are here to stay in some form — but the shape they eventually take will depend on decisions made by users, governments and technology companies over the coming decade.`,
        questions: [
          { id: "q11", type: "multiple-choice", question: "According to the passage, one reason social media appeals to users is that it…", options: ["is always more accurate than traditional news.", "satisfies several human needs simultaneously.", "replaces face-to-face friendships entirely.", "is completely free of advertising."], correctAnswer: 1 },
          { id: "q12", type: "multiple-choice", question: "Why do social media algorithms tend to amplify sensational content?", options: ["Because governments require it.", "Because emotional posts travel further and hold user attention.", "Because users prefer reading longer factual articles.", "Because platforms cannot control what they show."], correctAnswer: 1 },
          { id: "q13", type: "multiple-choice", question: "Which of the following is NOT mentioned in the passage as an effect of heavy social media use?", options: ["Anxiety", "Body-image concerns", "Physical strength", "Sleep disruption"], correctAnswer: 2 },
          { id: "q14", type: "true-false-not-given", question: "Most of the world's population now uses at least one social media platform.", correctAnswer: "true" },
          { id: "q15", type: "true-false-not-given", question: "Traditional television advertising is always cheaper than social media advertising.", correctAnswer: "false" },
          { id: "q16", type: "true-false-not-given", question: "TikTok has more users than Facebook.", correctAnswer: "not-given" },
          { id: "q17", type: "true-false-not-given", question: "Fact-checking labels have completely stopped the spread of misinformation.", correctAnswer: "not-given" },
          ...
          { id: "q19", type: "sentence-completion", question: "For platforms, user attention translates directly into ___________ revenue.", correctAnswer: "advertising" },
          { id: "q20", type: "sentence-completion", question: "Some critics call for breaking up the largest companies because their ___________ is now too great.", correctAnswer: "influence" },
        ],
      },
      {
        id: "passage-3",
...
Despite these obstacles, most experts believe that some form of driverless transport is inevitable. Trucks moving goods along motorways, taxis operating in fenced-off districts and shuttle buses on university campuses are all likely to become common in the next ten years. However, the vision of ordinary cars driving anywhere without human supervision is probably several decades away, and may never quite arrive.`,
        questions: [
          { id: "q21", type: "multiple-choice", question: "According to the passage, self-driving cars currently work best in which environment?", options: ["Busy city centres", "Motorways", "Country lanes", "Car parks"], correctAnswer: 1 },
          { id: "q22", type: "multiple-choice", question: "What is LIDAR?", options: ["A satellite navigation system", "A radar-based sensor", "A laser-based sensor", "A rule-based algorithm"], correctAnswer: 2 },
          { id: "q23", type: "multiple-choice", question: "Why is urban driving particularly difficult for self-driving cars?", options: ["Because cameras don't work in cities.", "Because cities have too many traffic lights.", "Because streets are full of unexpected events.", "Because urban roads are always narrower."], correctAnswer: 2 },
          { id: "q24", type: "true-false-not-given", question: "Self-driving cars have already caused fatal accidents.", correctAnswer: "true" },
          { id: "q25", type: "true-false-not-given", question: "Insurance and legal responsibility issues have been fully resolved.", correctAnswer: "false" },
          { id: "q26", type: "true-false-not-given", question: "Most experts believe fully autonomous cars will be common in the next five years.", correctAnswer: "false" },
          { id: "q27", type: "true-false-not-given", question: "Self-driving trucks on motorways are likely to become common within a decade.", correctAnswer: "true" },
          { id: "q28", type: "sentence-completion", question: "A fatal accident with a test self-driving vehicle occurred in ___________ in 2018.", correctAnswer: "Arizona" },
          { id: "q29", type: "sentence-completion", question: "In an unavoidable crash, programmers may effectively be writing rules that decide ___________.", correctAnswer: "life and death" },
          { id: "q30", type: "sentence-completion", question: "Human drivers handle unexpected events through experience, common sense and the ability to make ___________ with other road users.", correctAnswer: "eye contact" },
        ],
      },
    ],
  },
